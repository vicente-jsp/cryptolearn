...
export default function TagManagement() {
  ...
  return (
    <div>
      ...
      {/* Create Tag Form */}
      <form onSubmit={handleCreateTag} className="mb-8 p-4 bg-white dark:bg-gray-800 shadow-md rounded-lg">
        ...
        <div className="flex items-center space-x-4">
          <input
            ...
            className="w-full px-3 py-2 text-gray-900 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
          />
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4">
        ...
        <div className="flex flex-wrap gap-3">
          {tags.length > 0 ? (
            tags.map(tag => (
              <div key={tag.id} className="flex items-center bg-gray-200 dark:bg-gray-600 rounded-full px-4 py-2">
                <span className="text-gray-800 dark:text-gray-300 font-medium">{tag.name}</span>
